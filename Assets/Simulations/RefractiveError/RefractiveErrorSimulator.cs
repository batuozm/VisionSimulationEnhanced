...
public class RefractiveErrorSimulator : MonoBehaviour
{
    ...
    public float CurrentAccommodationLeftDiopters => currentAccommodationLeft;
    public float CurrentAccommodationRightDiopters => currentAccommodationRight;
    ...
    private void UpdateResidualErrors(float demand)
    {
    ...
    {
        // Negative sphere means myopia, positive sphere means hyperopia.
        // Accommodation adds optical power.
